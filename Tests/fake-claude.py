...
if os.environ.get('TEST_MODE')=='readOnly': assert args[args.index('--tools')+1]=='Read,Glob,Grep'
...
expected='deny' if os.environ.get('TEST_DECISION')=='decline' or os.environ.get('TEST_MODE')=='readOnly' else 'allow'
